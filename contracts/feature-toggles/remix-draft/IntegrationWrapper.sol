...
//         rentalId: 0,  // начальное значение; может потребоваться реальное значение
//         rentalAgreement: Rentings.Agreement({/* fake data for testing */}),
//         rentalEarnings: Accounts.RentalEarnings({/* fake data for testing */})
//     });

//     return featureControllerInstance.execute(msg.sender, executionObject);
// }
