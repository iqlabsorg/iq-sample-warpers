import { shouldBeLikeIntegrationFeatureRegistry } from './integration-feature-registry.behaviour';
  ...
  describe('IntegrationFeatureRegistry', function () {
    beforeEach(async function () {
      const fixtureIntegrationFeatureRegistry = async (): Promise<{
        ...
        const integrationFeatureRegistry = (await hre.run('deploy:feature-toggles:integration-feature-registry')) as IntegrationFeatureRegistry;
      ...
      this.contracts.integrationFeatureRegistry = {
        integrationFeatureRegistry,
      };
    });

    shouldBeLikeIntegrationFeatureRegistry();
  });
}
